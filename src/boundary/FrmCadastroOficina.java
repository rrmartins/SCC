 ...
 */
public class FrmCadastroOficina extends javax.swing.JDialog {
    ...
    public FrmCadastroOficina() throws MinhaException, SQLException, ConexaoException {
        initComponents();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jTFNomeOficina, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 288, Short.MAX_VALUE)
                    ...
                    .addComponent(jTFRua, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 288, Short.MAX_VALUE)
                           ...
                           if (!this.jTFRua.getText().isEmpty())
                           {
                               if (!this.jTFNumero.getText().isEmpty())
                               {
                                  if (!this.jTFBairro.getText().isEmpty())
                                  {
                                        ...
                                        {
                                            try {
                                               this.cadastroOficina.inserirNovoOficina(novaOficina);
                                            } catch (MinhaException ex) {
                                                Logger.getLogger(FrmCadastroOficina.class.getName()).log(Level.SEVERE, null, ex);
                                            } catch (ConexaoException ex) {
                                                    Logger.getLogger(FrmCadastroOficina.class.getName()).log(Level.SEVERE, null, ex);
